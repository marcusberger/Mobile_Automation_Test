...
public class Utils {
    ...
    public static void acessarApp() throws MalformedURLException, InterruptedException {
        ...
        desiredCapabilities.setCapability("deviceName", "RQCT203D8XM");
        desiredCapabilities.setCapability("automationName", "uiautomator2");
        desiredCapabilities.setCapability("appPackage", "com.calculadora");
        desiredCapabilities.setCapability("appActivity", "com.calculadora.MainActivity");
